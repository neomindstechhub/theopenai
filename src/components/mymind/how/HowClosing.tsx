...
export default function HowClosing() {
  return (
    <section
      id="section_7b36ec7bb"
    ...
    >
      <div className="mx-auto max-w-4xl px-6 sm:px-8 text-center flex flex-col items-center">
        ...
        >
          <img
            src="/images/how/Closing-Icon.svg"
            alt="Closing Icon"
        ...
        >
          ...
          <br />
          <br />
          It’s a refreshing approach to remembering the things you deeply care about.
        </motion.h2>
