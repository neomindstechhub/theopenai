...
const USE_CASES: UseCase[] = [
  {
    label: "Notaries",
    headline: "Go from 4 bookings a month ",
    headlineItalic: "to nearly two a day.",
    image: "/images/Designers.webp",
    color: "#FF5924",
  },
  {
    label: "Real Estate",
    headline: "Own your listings, leads & ",
    headlineItalic: "reputation in one place.",
    image: "/images/READ.webp",
    color: "#FF7DD3",
  },
  {
    label: "CPAs",
    headline: "Stop paying agencies $3,200 for a site ",
    headlineItalic: "you can't even edit.",
    image: "/images/BKMRK.webp",
    color: "#85D3FF",
  },
  {
    label: "Salons",
    headline: "Automate reviews, bookings & ",
    headlineItalic: "client follow-ups.",
    image: "/images/COL.webp",
    color: "#5CB13E",
  },
  {
    label: "Restaurants",
    headline: "Get found on Google, Maps & ChatGPT. ",
    headlineItalic: "Fill more tables.",
    image: "/images/SEREN.webp",
    color: "#FFE926",
  },
  {
    label: "Electricians",
    headline: "Rank above the big guys ",
    headlineItalic: "without the big budget.",
